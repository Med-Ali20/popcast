...
const ImageCards = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      title: "2000s",
      description:
        "الألفينات شهدت الانفجار الكبير بعد صعود القنوات الفضائية المتخصصة مثل روتانا، ميلودي، و مزيكا. الألبومات والإنتاجات البصرية وصلت إلى ذروتها، واصبحت المنافسة بين النجوم مشتعلة على مدار الساعة. هذه حقبة قدّمت النضج الفني والتجريب البصري، ورسّخت الصورة الحديثة للبوب العربي في الذاكرة الجماعية.",
    },
    {
      decade: "2010s",
      title: "2010s - 2020s",
      description:
        "في هذا العقد برزت التحديات: اضطرابات سياسية أثرت على الإنتاج، وتراجع الدعم المالي، وعدم مواكبة سريعة للتحولات الرقمية. رغم ذلك، ظل نجوم التسعينات والألفينات مسيطرين، بينما واجه الجيل الجديد صعوبة في ترسيخ مكانته. كانت مرحلة انتقالية كشفت هشاشة الصناعة أمام ثورة البث عبر الإنترنت والمنصات الحديثة.",
    },
  ];
          ...
          >
            ...
            <div className="absolute -top-[15%] -right-[5%] w-[90px] rounded-full h-[90px] bg-primary md:w-24 md:h-24 flex items-center justify-center">
              <div className="w-20 h-20 md:w-20 md:h-20 rounded-full z-50 relative overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
                <FlipImage decade={card.decade} className="w-full h-full" />
              </div>
            </div>
          </div>
        </Slide>
