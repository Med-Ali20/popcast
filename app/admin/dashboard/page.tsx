...
import { Mic2, FileText, Users, Lock, Eye, EyeOff, AlertCircle, CheckCircle } from 'lucide-react'
...
const Dashboard = () => {
  ...
  const handlePasswordSubmit = async () => {
    ...
    try {
      ...
      console.log('Password change requested:', { currentPassword: passwordData.currentPassword, newPassword: passwordData.newPassword })
  ...
  return (
    <div className="min-h-screen bg-secondary p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-600 mb-8">Admin Dashboard</h1>
          ...
          <Link href="/admin/podcast" className="col-span-2">
            <div className="bg-secondary rounded-lg p-8 border border-primary hover:border-blue-500 transition-all duration-300 hover:scale-105 cursor-pointer group">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-black mb-2">Manage Podcasts</h2>
                  <p className="text-gray-500">Add, edit, and manage your podcast episodes</p>
                </div>
              </div>
            </div>
          </Link>
          ...
          <Link href="/admin/articles">
            <div className="bg-secondary rounded-lg p-8 border border-primary hover:border-blue-500 transition-all duration-300 hover:scale-105 cursor-pointer group">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-black mb-2">Manage Articles</h2>
                  <p className="text-gray-500">Create and manage blog articles</p>
                </div>
              </div>
            </div>
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-2xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-black">Change Your Password</h2>
          </div>

          {message.text && (
            <div className={`mb-6 ${message.type === 'error' ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'} border rounded-lg p-4 flex items-start gap-3`}>
              {message.type === 'error' ? (
