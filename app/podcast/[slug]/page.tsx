...
function createMetaDescription(description: string, maxLength: number = 155): string {
  if (!description) {
  ...
  try {
    ...
    return {
      ...
      openGraph: {
        ...
        description: description,
        type: 'music.song',
        url: `https://itspopcast.com/podcast/${params.slug}`,
        images: [{
      ...
      alternates: {
        canonical: `https://itspopcast.com/podcast/${params.slug}`,
      },
